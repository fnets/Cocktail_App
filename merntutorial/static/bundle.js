...
ReactDOM.render(React.createElement(CocktailList, null), document.getElementById('main'));

},{"./CocktailList":163,"react":159,"react-dom":3}],161:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
...
var CocktailFilter = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement('div', null, React.createElement('h3', null, 'Filter'), 'Ingredients:', React.createElement('select', { value: this.state.ingredients, onChange: this.onChangeIngredients }, React.createElement('option', { value: '' }, '(Any)'), React.createElement('option', { value: 'jugs\t' }, 'jugs'), React.createElement('option', { value: 'everything' }, 'everything')), React.createElement('br', null), 'Name:', React.createElement('select', { value: this.state.name, onChange: this.onChangeName }, React.createElement('option', { value: '' }, '(Any)'), React.createElement('option', { value: 'Bug Juice\t' }, 'Bug Juice'), React.createElement('option', { value: 'High School' }, 'High School ')), React.createElement('br', null), React.createElement('button', { onClick: this.submit }, 'Apply'));
  },
...
var CocktailRow = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement('tr', null, React.createElement('td', null, this.props.cocktail._id), React.createElement('td', null, this.props.cocktail.name), React.createElement('td', null, this.props.cocktail.strMeasure1), React.createElement('td', null, this.props.cocktail.ingredients), React.createElement('td', null, this.props.cocktail.instructions));
  }
});
...
var CocktailTable = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement('table', null, React.createElement('thead', null, React.createElement('tr', null, React.createElement('th', null, 'Id'), React.createElement('th', null, 'Name'), React.createElement('th', null, 'Measure'), React.createElement('th', null, 'Ingredients'), React.createElement('th', null, 'Instructions'))), React.createElement('tbody', null, cocktailRows));
  }
});
...
var CocktailList = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement('div', null, React.createElement('h1', null, 'Cocktail List'), React.createElement(CocktailFilter, { submitHandler: this.loadData }), React.createElement('hr', null), React.createElement(CocktailTable, { cocktails: this.state.cocktails }), React.createElement('hr', null), React.createElement(CocktailAdd, { addCocktail: this.addCocktail }));
  },
...
},{"./CocktailAdd":161,"./CocktailFilter":162,"jquery":2,"react":159,"react-dom":3}]},{},[160]);
